...
# Note: this script should be run as `./profile_range.sh 1gb` to test executing 10 (dont do 100 anymore) range queries on a database with 1gb of data
...
data_size_string=$1
workload_filename="10_range.txt"
