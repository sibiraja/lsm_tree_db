...
# Additional data
basic_variant_mean_times = [0.3224266666666667, 1.6951133333333332, 3.558126666666667, 8.00323, 23.896213333333332]
basic_variant_std_devs = [0.0006850466326381684, 0.004975622797421675, 0.011124949937465494, 0.10413633446379582, 0.3177701719097557]
...
plt.errorbar(file_sizes, mean_times, yerr=std_devs, fmt='-o', color='green', ecolor='orange', elinewidth=3, capsize=15, label='Multithreaded Skiplist FeatherDB')

plt.xscale('log')  # Set x-axis scale to logarithmic for better visualization
plt.xlabel('Data Size')
plt.ylabel('Average Time (minutes)')
plt.title('Latency of Range - Multithreaded Skiplist vs. Basic FeatherDB')
