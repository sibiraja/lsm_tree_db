...
plt.errorbar(file_sizes, mean_times, yerr=std_devs, fmt='-o', color='green', ecolor='orange', elinewidth=3, capsize=15, label='Varying SIZE_RATIO')

plt.xscale('log')  # Set x-axis scale to logarithmic for better visualization
plt.xlabel('Data Size')
plt.ylabel('Average Time (minutes)')
plt.title('Latency - Constant vs Varying Size Ratio')
